...
pub fn map_mouse_to_action(event: crossterm::event::MouseEvent, mouse_mode: bool) -> AppAction {
    if !mouse_mode {
...
mod tests {
    ...
    fn hit_test_panel_button_action_buttons() {
        assert_eq!(
            hit_test_panel_button(79, 23),
            Some(MousePanelButton::NotesSolToggle)
        );
        assert_eq!(
            hit_test_panel_button(88, 23),
            Some(MousePanelButton::NotesSolToggle)
        );
        ...
        assert_eq!(
            hit_test_panel_button(105, 23),
            Some(MousePanelButton::Clear)
        );
        assert_eq!(
            hit_test_panel_button(112, 23),
            Some(MousePanelButton::Clear)
        );
    }
    ...
    fn hit_test_panel_button_digit_grid_row1() {
        assert_eq!(
            hit_test_panel_button(79, 27),
            Some(MousePanelButton::Digit(1))
        );
        assert_eq!(
            hit_test_panel_button(90, 27),
            Some(MousePanelButton::Digit(1))
        );
        assert_eq!(
            hit_test_panel_button(91, 27),
            Some(MousePanelButton::Digit(2))
        );
        assert_eq!(
            hit_test_panel_button(101, 27),
            Some(MousePanelButton::Digit(2))
        );
        assert_eq!(
            hit_test_panel_button(102, 27),
            Some(MousePanelButton::Digit(3))
        );
        assert_eq!(
            hit_test_panel_button(112, 27),
            Some(MousePanelButton::Digit(3))
        );
    }
    ...
    fn hit_test_panel_button_digit_grid_rows2_and_3() {
        assert_eq!(
            hit_test_panel_button(79, 29),
            Some(MousePanelButton::Digit(4))
        );
        assert_eq!(
            hit_test_panel_button(91, 29),
            Some(MousePanelButton::Digit(5))
        );
        assert_eq!(
            hit_test_panel_button(102, 29),
            Some(MousePanelButton::Digit(6))
        );
        assert_eq!(
            hit_test_panel_button(79, 31),
            Some(MousePanelButton::Digit(7))
        );
        assert_eq!(
            hit_test_panel_button(91, 31),
            Some(MousePanelButton::Digit(8))
        );
        assert_eq!(
            hit_test_panel_button(102, 31),
            Some(MousePanelButton::Digit(9))
        );
    }
